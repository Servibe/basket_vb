				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="header-search">
							{!! Form::open(['url' => '/calentadores', 'method' => 'get', 'role' => 'search']) !!}
			...
			<div class="row">
				...
				<div id="aside" class="col-md-3">
					...
					<div class="aside">
						...
						{!! Form::open(['url' => '/calentadores', 'method' => 'get']) !!}
						<div class="checkbox-filter">
							<div>
								...
								<label style="font-weight: normal;">
									<span></span>
									Talla S
									<small>(<?php $talla = App\Producto::where('talla', 'S')->where('tipo_producto', 5)->count(); echo $talla; ?>)</small>
								</label>
							</div>
							<div>
								...
								<label style="font-weight: normal;">
									<span></span>
									Talla M
									<small>(<?php $talla = App\Producto::where('talla', 'M')->where('tipo_producto', 5)->count(); echo $talla; ?>)</small>
								</label>
							</div>
							<div>
								...
								<label style="font-weight: normal;">
									<span></span>
									Talla L
									<small>(<?php $talla = App\Producto::where('talla', 'L')->where('tipo_producto', 5)->count(); echo $talla; ?>)</small>
								</label>
							</div>
							<br>
					...
					<div class="aside">
						...
						<div>
							<div>
								<label>
									<a href="/ocultoCalentadores">
										...
										<span></span>
										Todos
										<small>(<?php $categoria = \DB::table('productos')->where('tipo_producto', 5)->count(); echo $categoria; ?>)</small>
									</a>
								</label>
							</div>
							<hr>
							<div>
								<label>
									<a href="/cintas?marca=nike">
										<img src="/images/Logo/marcas/Nike.png" alt="" width="30">
										<span></span>
										Nike
										<small>(<?php $categoria = \DB::table('productos')->where('proveedor', 'nike')->where('tipo_producto', 5)->count(); echo $categoria; ?>)</small>
									</a>
								</label>
							</div>
							<div>
								<label>
									<a href="/cintas?marca=nba">
										<img src="/images/Logo/marcas/NBA.png" alt="" width="15">&nbsp;&nbsp;&nbsp;&nbsp;
										<span></span>
										NBA
										<small>(<?php $categoria = \DB::table('productos')->where('proveedor', 'nba')->where('tipo_producto', 5)->count(); echo $categoria; ?>)</small>
									</a>
								</label>
							</div>
							<div>
								<label>
									<a href="/cintas?marca=jordan">
										<img src="/images/Logo/marcas/Jordan.png" alt="" width="30">
										<span></span>
										Jordan
										<small>(<?php $categoria = \DB::table('productos')->where('proveedor', 'jordan')->where('tipo_producto', 5)->count(); echo $categoria; ?>)</small>
									</a>
								</label>
							</div>
						</div>
