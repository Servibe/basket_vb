				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="header-search">
							{!! Form::open(['url' => '/cintas', 'method' => 'get', 'role' => 'search']) !!}
							...
							<div>
								<label>
									<a href="/ocultoCintas">
										...
										<span></span>
										Todos
										<small>(<?php $categoria = \DB::table('productos')->where('tipo_producto', 8)->count(); echo $categoria; ?>)</small>
									</a>
								</label>
							</div>
							<hr>
							<div>
								<label>
									<a href="/cintas?marca=nike">
										...
										<span></span>
										Nike
										<small>(<?php $categoria = \DB::table('productos')->where('proveedor', 'nike')->where('tipo_producto', 8)->count(); echo $categoria; ?>)</small>
									</a>
								</label>
							</div>
							<div>
								<label>
									<a href="/cintas?marca=nba">
										...
										<span></span>
										NBA
										<small>(<?php $categoria = \DB::table('productos')->where('proveedor', 'nba')->where('tipo_producto', 8)->count(); echo $categoria; ?>)</small>
									</a>
								</label>
							</div>
							<div>
								<label>
									<a href="/cintas?marca=jordan">
										...
										<span></span>
										Jordan
										<small>(<?php $categoria = \DB::table('productos')->where('proveedor', 'jordan')->where('tipo_producto', 8)->count(); echo $categoria; ?>)</small>
									</a>
								</label>
							</div>
						</div>
